...
const UHC_MEDICAID_ROWS: CarveoutRow[] = [
  ...
  },
  {
    ...
    state: 'NY',
    lineOfBusiness: 'medicaid',
    administrator: 'Optum (branded "United Behavioral Health of New York, I.P.A., Inc." for this plan)',
    administratorPayerId: 'unverified',
    abaAdministeredOn: 'unverified',
    notes: 'Optum runs a dedicated ABA provider orientation for this plan; no payer ID or medical/BH-side statement found for this specific Medicaid guide (do not conflate with the NY commercial UHG007 fact, which is a different guide).',
    sources: [src('https://public.providerexpress.com/content/dam/ope-provexpr/us/pdfs/clinResourcesMain/autismABA/nyaba/NYabaPres.pdf', 'Optum NY Medicaid ABA Provider Orientation (BH00869, 01/30/2025).')],
  },
  {
    family: 'unitedhealthcare',
    state: 'NJ',
...
const NEW_YORK_ROWS: CarveoutRow[] = [
  ...
  },
  {
    ...
    state: 'NY',
    lineOfBusiness: 'medicaid',
    administrator: 'none — in-house since 9/1/2021 (previously carved to eviCore)',
    administratorPayerId: 'N/A',
    abaAdministeredOn: 'unverified',
    notes: 'Molina Healthcare of New York (formerly Affinity). Until 9/1/2021, authorizations ran through eviCore; since then, Molina\'s own ABA care-review clinicians (including LBA reviewers) review in-house.',
  ...
  },
  {
    ...
    state: 'NY',
    lineOfBusiness: 'medicaid',
    administrator: 'none named — Fidelis administers ABA itself under its own clinical policy (FC.CP.BH.301.04)',
    administratorPayerId: 'unverified',
    abaAdministeredOn: 'unverified',
    notes: 'No BH vendor named anywhere in the guide.',
  ...
  },
  {
    ...
    state: 'NY',
    lineOfBusiness: 'medicaid',
    administrator: 'none named — Healthfirst runs its own ABA authorization policy in-house',
    administratorPayerId: 'unverified',
    abaAdministeredOn: 'unverified',
    notes: 'No BH vendor named anywhere in the guide.',
  ...
  },
  {
    ...
    state: 'NY',
    lineOfBusiness: 'medicaid',
    administrator: 'none named — authorization requests go to "MetroPlus CSS" (in-house)',
    administratorPayerId: 'unverified',
    abaAdministeredOn: 'unverified',
    notes: 'No external BH vendor named anywhere in the guide.',
  ...
  },
  {
    ...
    state: 'NY',
    lineOfBusiness: 'medicaid',
    administrator: 'unverified — Carelon Behavioral Health named only as an unconfirmed candidate ("historically manages Emblem’s behavioral benefit")',
    administratorPayerId: 'unverified',
    abaAdministeredOn: 'unverified',
    notes: 'EmblemHealth (HIP entities). Guide states public materials don\'t answer whether Carelon runs ABA UM for this plan.',
